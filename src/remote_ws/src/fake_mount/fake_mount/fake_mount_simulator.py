...
- Publishes RViz-only mechanical joints on /fake_mount/fake_joint_states
- Publishes sky RA/DEC on /fake_mount/fake_RaDec
...
class FakeMountSimulator(Node):
    def __init__(self):
        ...
        self._fake_pub = self.create_publisher(JointState, '/fake_mount/fake_joint_states', 10)
        self._fake_radec_pub = self.create_publisher(Vector3, '/fake_mount/fake_RaDec', 10)
    ...
    def _publish_feedback(self):
        ...
        fake.header.frame_id = 'fake_telescope'
        fake.name = ['fake_polar_align_joint', 'fake_ra_joint', 'fake_dec_joint']
        fake.position = [
