...
Consumes the dict produced by ``astrocam.cv.processing.histogram_rgb`` (keys
``red``/``green``/``blue``, each a list of 256 counts) and renders the three
channels as overlaid translucent columns scaled to the tallest bin.
"""
